    ...
    return (
        ...
        <Container style={{ marginBottom: '90px', marginTop: '90px'}} fluid>
            <Row style={{  display: 'flex', alignItem: 'center', justifyContent: 'center' }}>
                <Col xs={6} sm={6} md={4} lg={6}  style={{ position: 'relative', width: '100%', margin: '20px 30px', height: '900px', maxHeight: '100%', backgroundSize: '100%', backgroundRepeat: 'no-repeat', backgroundImage: `url(${mensFragrance})` }}>
                ...
                <Col xs={6} sm={6} md={4} lg={6} style={{  width: '100%', margin: '20px 30px', height: '900px', maxHeight: '100%', backgroundSize: '100%', backgroundRepeat: 'no-repeat', backgroundImage: `url(${womensFragrance})` }}>
